# Homie convention implementations
...
* A linux daemon to fetch and publish data from Mi Flora plant sensors: [miflora-mqtt-daemon](https://github.com/ThomDietrich/miflora-mqtt-daemon)
